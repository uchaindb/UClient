...
@NgModule({
    ...
    imports: [
        ...
        RouterModule.forRoot([
            ...
            { path: 'discover', component: DiscoverPage, canActivate: [AuthGuard], data: { title: "Discover", } },
            ...
            { path: 'database', component: DatabaseListPage, canActivate: [AuthGuard], data: { title: "db.List", } },
            ...
            { path: 'alert', component: AlertListPage, canActivate: [AuthGuard], data: { title: "alert.List", } },
            ...
            { path: 'user/keys', component: KeyManagePage, canActivate: [AuthGuard], data: { title: "me.Keys", backlink: false } },
